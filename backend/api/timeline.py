...
from models.requests import TimelineEventRequest

router = APIRouter()
logger = logging.getLogger("medimind.timeline")
...
def get_timeline(
    ...
    """Get the full chronological timeline for a patient."""
...
def add_event(
    ...
    """Add a manual event to a patient's timeline."""
    ...
    logger.info("timeline_event_added", extra={"patient_id": patient_id, "event_type": payload.event_type})
    return event
